...
## 7. Веб-интерфейс (Streamlit)

Streamlit — основной пользовательский интерфейс (кнопки, формы, графики); CLI — минимальный слой поверх той же библиотеки для скриптов, автоматизации и быстрой проверки из терминала. Оба работают с одними и теми же `Experiment`/`AnalysisResults` и одним `experiments_dir`.
